...
public class InventoryCheckAdapter extends RecyclerView.Adapter<InventoryCheckAdapter.CheckMaterialViewHolder> {

    private List<GetReturnDetailResponse.ResultBean.ResDataBean>  stockMoveLinesBeans ;
    private Context context ;
    public InventoryCheckAdapter(Context context) {
    ...
    public void setItems( List<GetReturnDetailResponse.ResultBean.ResDataBean> stockMoveLinesBeans){
    ...
    public List<GetReturnDetailResponse.ResultBean.ResDataBean> getItems(){
